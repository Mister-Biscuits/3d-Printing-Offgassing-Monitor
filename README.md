# 3d-Printing-Offgassing-Monitor
...
V1 has just a simple gas sensor and a 16x2 character display

V2 hopefully has both the simple gas sensor and a new air particulate sensor (potentially a pm2.5 sensor, though that may not be accurate enough)
